            ...
            <React.Fragment>
                        ...
                        <Grid item xs={12}>
                            ...
                            <RecentlyToken  onTokenClick={this.props.onTokenClick}/>
                                <a target={"_blank"} href={"https://opensea.io/collection/chinese-opera-mask-plus"}><Button style={{width:"100%",marginTop:"15px"}}>Show More COMP</Button></a>
                            </Grid>
                        </Grid>
                        ...
                        {/*                            <option value={""}>I'm In The Whitelist</option>*/}
                ...
                <Grid item xs={12}>
                    ...
                    <Staking account={this.state.account}
