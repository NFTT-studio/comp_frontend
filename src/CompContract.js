...
class CompContractUtil{
     ...
     cooltimeLeft = async(address)=>{
          ...
          let  [nextMintTime,airdropTime] = await Promise.all([
                    this.contract.addressNextMintData(address),
